...
const authService = {
  ...
  /**
   * Logout user and clear browser data. 
   * This function removes all stored authentication data and clears browser cache/storage related to this site.
   */
  logout() {
    try {
      ...
      window.location.href = `/login.html?logout=true&cb=${cacheBuster}`;
    } catch (error) {
