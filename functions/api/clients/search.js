export async function onRequest(context) {
  ...
  try {
    ...
    const endpoints = [
      ...
      `${supabaseUrl}/rest/v1/userfile?or=(USERNAME.ilike.%25${encodeURIComponent(searchTerm)}%25,BUSINESSNAME.ilike.%25${encodeURIComponent(searchTerm)}%25,EMAIL.ilike.%25${encodeURIComponent(searchTerm)}%25)`,
